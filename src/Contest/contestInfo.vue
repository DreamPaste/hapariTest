  ...
  <div class="container" style="background: #f8f8f8; display: flex; justify-content: center; margin: 100px 0;">
    <div class="backgroundCerti flex column items-center justify-center" style="background: #ffffff; padding: 2%;  height: 100%; width: 1200px;">
      ...
      <div class="col-1  row items-center justify-center"
           style=" width: 100%; height: 130px; font-family: 'Black Han Sans', sans-serif;  border-bottom: 1px solid rgba(83, 68, 152, 0.53);">
        <!-- 공모전 이름 -->
        <div class="col-6 flex row items-center justify-star" style="font-size: 2.5rem;  width: 100%; color: #413090;  ">
        공모전 이름 {{contestName}}</div>

        <!-- 공모전 날짜 -->
          <div class="col-6 flex row items-center justify-start"
               style="font-family: 'Gmarket Sans', sans-serif; font-weight: bold; font-size: 1.1rem;width:100%; height:50px;color: white; ">
      ...
      <!-- 공모전 포스터, 표 묶음 -->
      <div class="col-4 flex row items-center justify-between" style="width: 100%; height: 600px;">
        <!-- 공모전 포스터 -->
        <div class="col-6  flex row items-center justify-center" style=" width: 40%; height: 80%;  border: 1px solid rgba(83, 68, 152, 0.53);">image</div>
        <!-- 공모전 표, 버튼들 묶음 -->
        <div class="col-6  flex column items-center justify-between" style=" width: 45%; height: 80%;">
          <!-- 공모전 표-->
          <div class="contestTable col-9  flex row items-center justify-end" style="width: 100%; ">
            <div style="width: 100%; ">
           <InfoTable/>
            </div>
          </div>

          <div class=" col-3  flex row items-center justify-between " style="width:100%; height: 11%;">

            <q-btn class="contestBtn no-shadow"
              icon="navigation" label="접수하기" flat
              style="
             width: 35%;
              border-radius: 10px;
            ...
            <button  @click="toggleLike"
                    style="
                    background: rgba(250,225,233,0.64);
                    border-radius: 50px;
                     width:55px;
                    height: 100%;
...
이런 공모전도 확인해보세요
        ...
        <!-- 추천 공모전 이미지-->
        <div class = "col-10 row  items-center justify-center" style=" background: rgba(213,236,250,0.39); border-radius: 10px;  width: 100%; height: 250px; ">
          <div class = "col-10 row  items-center justify- justify-evenly" style=" width: 100%;  ">
